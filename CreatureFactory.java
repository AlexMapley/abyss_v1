...
/* * * * * * Creatures for Assembly * * * * * */
    ...
    public Creature newPlayer(List<String> messages){
        Creature player = new Creature(world, "Player", 'A', AsciiPanel.brightWhite, 0, 0, 0, 0, 0, 0, 0, 0);
    ...
    public Creature newFungus(){
        Creature fungus = new Creature(world, "Fungus", 'f', AsciiPanel.green, 20, 2, 1, 5, 3, 0, 0, 1);
    ...
    public Creature newGoblin(){
        Creature goblin = new Creature(world, "Goblin", 'G', AsciiPanel.brightGreen, 45, 5, 3, 10, 3, 0, 2, 4);
    ...
    public Creature newMole(){
        Creature mole = new Creature(world, "Mole", 'M', AsciiPanel.brightCyan, 145, 20, 25, 18, 12, 5, 10, 10);
    ...
    public Creature newReaper(){
        Creature Reaper = new Creature(world, "Reaper", 'R', AsciiPanel.brightRed, 1000, 999, 100000, 100, 100, 10, 5, 100);
